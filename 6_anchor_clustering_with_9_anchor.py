...
# 바운딩 박스 추출
labels_path = '/home/ailab/git/AUE8088_PA2/jaehwan/AUE8088-PA2/datasets/nuscenes/train/labels'  # train set의 labels 폴더 경로 설정
bounding_boxes = extract_bounding_boxes_from_labels(labels_path)
print(f'Extracted {len(bounding_boxes)} bounding boxes')
...
# 이미지 사이즈에 맞는 앵커 계산
image_path = '/home/ailab/git/AUE8088_PA2/jaehwan/AUE8088-PA2/datasets/nuscenes/val/images/0a0d6b8c2e884134a3b48df43d54c36a.png'
image = Image.open(image_path)
image_width, image_height = image.size
print(f'Image size: {image_width}x{image_height}')
...
# 앵커 크기 계산 (너비 * 높이)
anchor_areas = anchors_scaled[:, 0] * anchors_scaled[:, 1]
